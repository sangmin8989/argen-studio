...
export default function Hero() {
  ...
  // Cinematic scroll mask — viewport shrinks + rounds on scroll
      ...
      >
        ...
        >
          <div>
            ...
            <div className="mb-4 flex flex-col items-center overflow-hidden">
              <h1 className="leading-[1] flex items-baseline">
                {['A', 'R'].map((char, i) => (
                  <motion.span
                    key={`ar-${i}`}
                    className="font-serif text-[clamp(3rem,7.5vw,6rem)] font-normal tracking-[-0.01em] text-warm-100 inline-block"
              ...
              <h1 className="leading-[1] flex items-baseline mt-1">
                {['G', 'E', 'N'].map((char, i) => (
                  <motion.span
                    key={`gen-${i}`}
                    className="font-serif text-[clamp(2.6rem,6.5vw,5.2rem)] font-normal tracking-[-0.01em] text-warm-100 inline-block"
                    initial={{ y: '100%', opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
            ...
            {/* Tagline — 시 한 줄 */}
            <motion.p
              className="font-sans text-[clamp(0.85rem,1.6vw,1.05rem)] font-light text-warm-200/80 mb-12 tracking-[0.12em]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <MagneticButton onClick={() => scrollTo('#portfolio')} className="px-9 py-4 border border-warm-100/40 text-warm-100 font-sans font-medium text-[11px] tracking-[0.22em] uppercase rounded-none hover:bg-warm-100/5 transition-colors duration-500">
