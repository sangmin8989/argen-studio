...
const dict = {
  ...
  'services.apartment': { ko: '아파트 인테리어', en: 'Apartment Interior' },
  'services.apartmentDesc': { ko: '신축 및 구축 아파트의 공간 재구성. 가족 구성과 라이프스타일에 맞춘 실용적이고 세련된 주거 공간을 완성합니다.', en: 'Space reconfiguration for apartments. Creating practical and refined living spaces tailored to family needs.' },
  ...
  'portfolio.subtitle': { ko: '아르젠 디자인이 완성한 공간들', en: 'Spaces completed by ARGEN DESIGN' },
